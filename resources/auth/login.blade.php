            ...
            <div class="row gx-lg-5 align-items-center">
              <div class="col-lg-6 mb-5 mb-lg-0">
                <h1 class="my-5 display-3 fw-bold ls-tight text-light">
                  The best website <br />
                  <span class="" style="color: #03e9f4">to create your note</span>
                </h1>
              ...
              <div class="col-lg-6 mb-5 mb-lg-0">
                <div class="login-box">
                    ...
                    <form class="shadow-lg mt-5" action="{{ route('login') }}" method="POST" style="height: 500px">
                        @csrf
                        <h2 style="color:#03e9f4">Login</h2><br>
                   ...
                   <h5 class="text-center mt-5 text-light fs-4">Don't have an account?</h5>

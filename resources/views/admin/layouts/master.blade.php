...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <h4 class="fs-5 text-danger">Red Devil's Pizzeria</h4>
            </div>
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{route('admin#contactPage')}}">
                                <i class="fa-solid fa-envelope"></i>User's Message</a>
                        </li>
    ...
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <div class="header-wrap">
                <div class="">
                    <h3 class="text-warning">Admin Pannel</h3>
                </div>
         <div class="header-button">
                    ...
                    <div class="account-wrap">
                        <div class="account-item clearfix js-item-menu">
                            ...
                            <div class="content">
                                <a class="js-acc-btn text-danger" href="#">{{ Auth::user()->name }}</a>
                            </div>
                            <div class="account-dropdown js-dropdown">
                                ...
                                <div class="account-dropdown__footer">
                                    <form action="{{route('logout')}}" method="POST" class="d-flex justify-content-center">
                                        @csrf
                                        <button type="submit" class="btn btn-outline-danger my-3 col-5">Logout <i class="fa-solid fa-right-from-bracket"></i></button>
                                    </form>
                                </div>
                            </div>
                        </div>

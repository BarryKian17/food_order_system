        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-3 offset-8">
                    <a href="{{route('category#list')}}"><button class="btn btn-outline-dark my-3 px-3 fw-bold "><i class="fa-solid fa-list"></i> List </button></a>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">
                            <h3 class="text-center title-2 text-danger">Create Your Category</h3>
                        </div>
                        <hr>

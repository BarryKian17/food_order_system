        ...
        <div class="container-fluid">
            <div class="col-md-12">
                ...
                <div class="col-3 offset-9">
                    <form action="{{ route('category#list') }}" method="GET" class="d-flex border border-0 rounded-right">
                        @csrf
                ...
                <table class="table table-data2 text-center">
                    <thead>
                        <tr>
                            ...
                            <th class="text-danger">Created_date</th>
                         </tr>
                    </thead>
                    <tbody>
                        ...
                        <td>
                            <div class="table-data-feature">
                                ...
                                <a href="{{  route('category#edit',$category->id) }}">
                                    <button class="mx-1 btn btn-outline-warning rounded-circle" data-toggle="tooltip" data-placement="top" title="Edit">
              ...
              @else
                 <H2>There is no Category Here!!</H2>
              @endif
                <!-- END DATA TABLE -->
            </div>
        </div>

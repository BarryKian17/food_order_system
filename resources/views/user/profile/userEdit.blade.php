...
<div class="main-content">
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <div class="row">
                <div class="col-3">
                    <a href="{{route('user#accountPage')}}"><button class="btn btn-outline-dark my-3 px-3"><i class="fa-sharp fa-solid fa-arrow-left mx-2"></i>Back </button></a>
                </div>
            </div>
                        ...
                        <form action="{{ route('user#update',Auth::user()->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-4 offset-1 text-center">
                                    ...
                                    @endif
                                    @else
                                        <img src="{{asset('storage/'.Auth::user()->image)}}"class="rounded w-75" alt="John Doe" />
                                    @endif
